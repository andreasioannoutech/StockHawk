...
/**
 * Created by kikkos on 10/31/2016.
 */
...
public class StocksWidgetProvider extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int appWidgetId : appWidgetIds) {
            ...
            // Create an Intent to launch MyStocksActivity if user click on widget bar.
            ...
            // Create intent to launch charts activity if user selects any quote from the widget.
...
//             Tell the AppWidgetManager to perform an update on the current app widget
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        // receiving data from sync adapter
    ...
    private void setRemoteAdapterV11(Context context, @NonNull final RemoteViews views) {
        views.setRemoteAdapter(0, R.id.widget_list, new Intent(context, StocksWidgetRemoteViewsService.class));
    }
}
